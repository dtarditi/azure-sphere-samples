...
IF(DEFINED AZSPHERE_CMAKE_ROOT)
    STRING(REPLACE "\\" "/" AZSPHERE_CMAKE_ROOT ${AZSPHERE_CMAKE_ROOT})
    STRING(FIND ${AZSPHERE_CMAKE_ROOT} "/" AZURE_SPHERE_CMAKE_PATH_END REVERSE)
    STRING(SUBSTRING ${AZSPHERE_CMAKE_ROOT} 0 ${AZURE_SPHERE_CMAKE_PATH_END} AZURE_SPHERE_CMAKE_PATH)
...
IF(${CMAKE_HOST_WIN32})
    SET(CMAKE_C_COMPILER "C:/Program Files/CheckedC-LLVM/bin/clang.exe" CACHE INTERNAL "Path to the C compiler in the selected Sysroot targeting High-Level core")
ELSE()
...
-B \"${AZURE_SPHERE_SYSROOT_DIR}/usr/lib/arm-poky-linux-musleabi/8.2.0\"")
